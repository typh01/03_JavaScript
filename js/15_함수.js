...
btn1.addEventListener("click", function(){
  ...
  // #input1인 요소에 작성된 값을 얻어오 number 타입으로 변환
...
btn2.addEventListener("click", function(){
  const inputs = document.querySelectorAll("[name = input2]"); // 중복 방지를 위해 {}단위 에서 해결
...
btn5.addEventListener("click", function(){
  ...
  const arr = createArrary(5); // 생성된 배열을 반환 받아 저장
