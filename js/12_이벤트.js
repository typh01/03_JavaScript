...
/* 내가 푼 답 + 빈 칸이면 rgb 추가 */
// const input = document.querySelectorAll(".inputColor");
...
//       display[i].style.backgroundColor = `rgb(${r}, ${g}, ${b})`
//       continue;
//     }

//     display[i].style.backgroundColor = input[i].value;
//   }
// })
